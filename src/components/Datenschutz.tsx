    ...
    <div className="prose max-w-none">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 mb-4">
          ...
          z.B. um Daten handeln, die Sie uns per E-Mail oder Telefon übermitteln.
        </p>
        <p className="text-gray-700">
      ...
      <section className="mb-8">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Allgemeine Hinweise zu den Rechtsgrundlagen der Datenverarbeitung auf dieser Website</h3>
        <p className="text-gray-700 mb-4">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
        <p className="text-gray-700 mb-4">
        ...
        <div className="bg-gray-50 p-4 rounded-lg mb-4">
          <p className="text-gray-700">Landesbeauftragte für Datenschutz und Informationsfreiheit Nordrhein-Westfalen</p>
          <p className="text-gray-700">Postfach 20 04 44</p>
          <p className="text-gray-700">40102 Düsseldorf</p>
          <p className="text-gray-700 mt-2">Telefon: 0211/38424-0</p>
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-700 mb-4">
          Diese Website bietet kein Kontaktformular. Für Anfragen nutzen Sie bitte die im Impressum angegebenen 
          Kontaktmöglichkeiten, z. B. Telefon: 0800 77777 27 oder E-Mail: Theissankauf@web.de.
        </p>
        <p className="text-gray-700 mb-4">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Anfrage per Telefon</h3>
        <p className="text-gray-700">
          Wenn Sie uns per Telefon kontaktieren, wird Ihre Telefonnummer zur Bearbeitung der Kontaktanfrage und deren 
          Abwicklung verarbeitet und temporär gespeichert. Die Verarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 
      ...
      <section className="mb-8">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Recht auf Auskunft</h3>
        <p className="text-gray-700 mb-4">
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Recht auf Löschung und Einschränkung der Verarbeitung</h3>
        <p className="text-gray-700 mb-4">
        ...
        <p className="text-gray-700 mb-4">
          Sie haben das Recht, Sie betreffende Daten, die Sie uns bereitgestellt haben, nach Maßgabe der gesetzlichen 
          Vorgaben in einem strukturierten, gängigen und maschinenlesbaren Format zu erhalten oder deren Übermittlung 
          an einen anderen Verantwortlichen zu fordern.
        </p>

        <h3 className="text-xl font-semibold text-gray-900 mb-3">Recht auf Beschwerde bei Aufsichtsbehörde</h3>
        <p className="text-gray-700 mb-4">
          Sie haben unbeschadet eines anderweitigen verwaltungsrechtlichen oder gerichtlichen Rechtsbehelfs das Recht 
          auf Beschwerde bei einer Aufsichtsbehörde, insbesondere in dem Mitgliedstaat ihres gewöhnlichen 
        ...
        <h3 className="text-xl font-semibold text-gray-900 mb-3">Kontakt für Datenschutzanfragen</h3>
        <p className="text-gray-700 mb-4">
