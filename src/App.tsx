        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="flex justify-between items-center h-24 sm:h-20">
            <div className="flex flex-col">
              {/* Mobile: smaller text, 1 line / Desktop: normal size */}
              <div className="flex items-center space-x-1 sm:space-x-2">
                <span className="text-base sm:text-2xl lg:text-3xl font-bold text-amber-600">Churros</span>
                <span className="text-sm sm:text-xl lg:text-2xl font-bold text-gray-400">&</span>
